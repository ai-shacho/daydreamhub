...
// Force rebuild to reload Cloudflare Worker env vars (cache-bust marker: 2026-07-14)
  ...
  if (action === 'dial') {
    ...
    try {
      ...
      const twilioReqSummary = {
        url: `https://api.twilio.com/2010-04-01/Accounts/${maskSecret(env.TWILIO_ACCOUNT_SID)}/Calls.json`,
        to: to_number,
