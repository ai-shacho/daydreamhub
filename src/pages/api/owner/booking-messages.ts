    ...
    try {
      await fetch('https://api.resend.com/emails', {
        ...
        body: JSON.stringify({
          ...
          html: `<div style="font-family:Arial,sans-serif;max-width:600px"><h3>Message from ${booking.hotel_name}</h3><p>Regarding your booking #${booking_id}</p><blockquote style="border-left:3px solid #0d9488;padding:8px 16px;color:#374151">${content.trim()}</blockquote><a href="https://daydreamhub.com/mypage" style="display:inline-block;margin-top:16px;padding:10px 20px;background:#0d9488;color:white;text-decoration:none;border-radius:6px">View in My Bookings</a></div>`,
        }),
      });
    } catch {}
  }
