  ...
  <div style="padding:28px 24px;border:1px solid #e5e7eb;border-top:none;border-radius:0 0 8px 8px;background:#ffffff">
    ...
    <div style="background:#f0fdfa;border:1px solid #99f6e4;border-radius:8px;padding:20px;margin:20px 0">
      ...
      <table style="border-collapse:collapse;width:100%">
        ...
        <tr><td style="padding:7px 10px;border:1px solid #d1fae5;font-weight:600;background:#f0fdfa;font-size:13px">Cancellation Policy</td><td style="padding:7px 10px;border:1px solid #d1fae5;font-size:13px">${data.cancellationHours === 0 ? '❌ Non-refundable<br><span style="color:#6b7280;font-size:12px">Once the hotel confirms your booking, cancelling gives no refund.</span>' : `✅ Free cancellation up to ${data.cancellationHours ?? 24}h before check-in<br><span style="color:#6b7280;font-size:12px">Counted in the hotel\u2019s local time, not your own time zone.</span>`}</td></tr>
      </table>
    </div>
